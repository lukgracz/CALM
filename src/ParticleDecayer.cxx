...
int ParticleDecayer::TwoBodyDecay()
{
  ...
  mFather->SetDecayed();
  tDaughter1->SetParticlePX(tPe1, tPx1, tPy1, tPz1, rtr, rxr, ryr, rzr, mFather->GetWeight(), mFather);
  tDaughter2->SetParticlePX(tPe2, tPx2, tPy2, tPz2, rtr, rxr, ryr, rzr, mFather->GetWeight(), mFather);
...
// Decay coordinates
  ...
  tDaughter1->SetParticlePX(tPe1, tPx1, tPy1, tPz1, rtr, rxr, ryr, rzr, mFather->GetWeight(), mFather);
  tDaughter2->SetParticlePX(tPe2, tPx2, tPy2, tPz2, rtr, rxr, ryr, rzr, mFather->GetWeight(), mFather);
  tDaughter3->SetParticlePX(tPe3, tPx3, tPy3, tPz3, rtr, rxr, ryr, rzr, mFather->GetWeight(), mFather);
  mParticles->push_back(*tDaughter1);
  mParticles->push_back(*tDaughter2);
